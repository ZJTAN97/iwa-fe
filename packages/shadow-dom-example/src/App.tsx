    ...
    <div className={`app${darkMode ? " app-dark" : ""}`}>
      <header className="app-header">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start" }}>
          <div>
            <span className="app-badge">Shadow DOM Approach</span>
            <h1>News Reader — Shadow DOM Example</h1>
            <p>
              External news content is embedded via Shadow DOM. The content shares
              the same browsing context but has style isolation through the shadow
              boundary.
            </p>
          </div>
        ...
        <p className="dark-mode-hint">
          Dark mode uses <strong>direct DOM access</strong> to toggle the article's theme class.
        </p>
      </header>
        ...
        <div>
          <div className="embed-container">
            <div className="embed-label">
              Embedded Content (Shadow DOM)
            </div>
            <NewsEmbed onNewsAction={handleNewsAction} darkMode={darkMode} />
          </div>

          <div className="event-log">
            <h2>Event Log (composed custom events from Shadow DOM)</h2>
